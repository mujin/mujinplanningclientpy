...
class RealtimeRobotPlanningClient(planningclient.PlanningClient):
    ...
    def GetJointValues(self, timeout=10, executetimeout=10, unit='mm', robotname=None, toolname=None, robotBridgeConnectionInfo=None, locationCollisionInfos=None, **kwargs):
    ...
    def GetTransform(self, targetname, connectedBodyName=None, linkName=None, geometryName=None, geometryPk=None, unit='mm', timeout=10, **kwargs):
    ...
    def GetInstObjectAndSensorInfo(self, instobjectnames=None, sensornames=None, unit='mm', timeout=10, ignoreMissingObjects=None, **kwargs):
    ...
    def GetInstObjectInfoFromURI(self, instobjecturi=None, unit='mm', timeout=10, instobjectpose=None, **kwargs):
    ...
    def SetLocationTracking(self, timeout=10, fireandforget=False, cycleIndex=None, locationReplaceInfos=None, removeLocationNames=None, minRobotBridgeTimeStampUS=None, dynamicObstacleBaseName=None, targetUpdateBaseName=None, ioSignalsInfo=None, unit='mm', **kwargs):
    ...
    def ResetLocationTracking(self, timeout=10, fireandforget=False, resetAllLocations=None, resetLocationName=None, resetLocationNames=None, checkIdAndResetLocationName=None, **kwargs):
    ...
    def GetLocationTrackingInfos(self, fireandforget=False, timeout=10, **kwargs):
    ...
    def UpdateLocationContainerIdType(self, locationName, containerName, containerId, containerType, trackingCycleIndex=None, timeout=10, fireandforget=False, unit='mm', **kwargs):
        """Resets the tracking of specific containers
    ...
    def RemoveObjectsWithPrefix(self, prefix=None, removeNamePrefixes=None, timeout=10, fireandforget=False, removeLocationNames=None, doRemoveOnlyDynamic=None, locationName=None, locationContainerId=None, imageStartTimeStampMS=None, callerid=None, **kwargs):
    ...
    def GetTrajectoryLog(self, timeout=10, startindex=None, num=None, includejointvalues=False, saverawtrajectories=None, **kwargs):
    ...
    def ChuckGripper(self, robotname=None, grippername=None, timeout=10, toolname=None, robotspeed=None, robotaccelmult=None, ionames=None, **kwargs):
    ...
    def UnchuckGripper(self, robotname=None, grippername=None, timeout=10, targetname=None, toolname=None, pulloutdist=None, deletetarget=None, unit='mm', robotBridgeConnectionInfo=None, locationCollisionInfos=None, robotspeed=None, robotaccelmult=None, ionames=None, **kwargs):
    ...
    def CalibrateGripper(self, robotname=None, grippername=None, timeout=10, fireandforget=False, toolname=None, robotspeed=None, robotaccelmult=None, ionames=None, **kwargs):
    ...
    def StopGripper(self, robotname=None, grippername=None, timeout=10, fireandforget=False, toolname=None, robotspeed=None, robotaccelmult=None, ionames=None, **kwargs):
        """
    ...
    def MoveGripper(self, grippervalues, robotname=None, grippername=None, timeout=10, fireandforget=False, toolname=None, unit='mm', robotBridgeConnectionInfo=None, locationCollisionInfos=None, robotspeed=None, robotaccelmult=None, ionames=None, **kwargs):
    ...
    def ExecuteRobotProgram(self, robotProgramName, robotname=None, timeout=10, fireandforget=False, unit='mm', toolname=None, robotBridgeConnectionInfo=None, locationCollisionInfos=None, robotspeed=None, robotaccelmult=None, ionames=None, **kwargs):
    ...
    def SaveScene(self, timeout=10, filename=None, preserveexternalrefs=None, externalref=None, saveclone=None, saveReferenceUriAsHint=None, **kwargs):
    ...
    def SaveGripper(self, timeout=10, robotname=None, filename=None, manipname=None, unit='mm', toolname=None, robotBridgeConnectionInfo=None, locationCollisionInfos=None, **kwargs):
    ...
    def GetRobotBridgeIOVariables(self, ioname=None, ionames=None, robotname=None, timeout=10, unit='mm', toolname=None, robotBridgeConnectionInfo=None, locationCollisionInfos=None, **kwargs):
    ...
    def SetRobotBridgeIOVariables(self, iovalues, robotname=None, timeout=10, unit='mm', toolname=None, robotBridgeConnectionInfo=None, locationCollisionInfos=None, forceasync=None, **kwargs):
    ...
    def ComputeIkParamPosition(self, name, robotname=None, timeout=10, toolname=None, unit='mm', jointvalues=None, **kwargs):
    ...
    def ComputeIKFromParameters(
        ...
        ikparamnames=None,
        limit=None,
        useSolutionIndices=None,
        disabletarget=None,
        unit='mm',
        randomBoxInfo=None,
        freeincvalue=None,
        freeinc=None,
        applyapproachoffset=None,
        inPlaneAngleDeviation=None,
        outOfPlaneAngleDeviation=None,
        searchfreeparams=None,
        returnClosestToCurrent=None,
    ...
    def ShutdownRobotBridge(self, timeout=10, unit='mm', robotname=None, toolname=None, robotBridgeConnectionInfo=None, locationCollisionInfos=None, **kwargs):
        """
    ...
    def GetRobotBridgeState(self, timeout=10, unit='mm', robotname=None, toolname=None, robotBridgeConnectionInfo=None, locationCollisionInfos=None, ionames=None, **kwargs):
        """
    ...
    def ClearRobotBridgeError(self, timeout=10, unit='mm', robotname=None, toolname=None, robotBridgeConnectionInfo=None, locationCollisionInfos=None, **kwargs):
        """
    ...
    def SetRobotBridgePause(self, timeout=10, unit='mm', robotname=None, toolname=None, robotBridgeConnectionInfo=None, locationCollisionInfos=None, **kwargs):
        """
    ...
    def SetRobotBridgeResume(self, timeout=10, unit='mm', robotname=None, toolname=None, robotBridgeConnectionInfo=None, locationCollisionInfos=None, **kwargs):
        """
    ...
    def SetJogModeVelocities(self, movejointsigns, robotname=None, toolname=None, robotspeed=None, robotaccelmult=None, canJogInCheckMode=None, timeout=1, fireandforget=False, jogtype=None, checkSelfCollisionWhileJogging=None, force=None, unit='mm', robotBridgeConnectionInfo=None, locationCollisionInfos=None, robotJogParameters=None, simulationtimestep=None, plotDirection=None, **kwargs):
        """
    ...
    def SetRobotBridgeServoOn(self, servoon, robotname=None, timeout=3, fireandforget=False, **kwargs):
        """
    ...
    def SetRobotBridgeLockMode(self, islockmode, robotname=None, timeout=3, fireandforget=False, **kwargs):
        """
    ...
    def ResetSafetyFault(self, timeout=3, fireandforget=False, **kwargs):
        """
    ...
    def SetRobotBridgeControlMode(self, controlMode, timeout=3, fireandforget=False, **kwargs):
        """
    ...
    def ComputeRobotConfigsForGraspVisualization(self, targetname, graspname, robotname=None, toolname=None, unit='mm', timeout=10, approachoffset=None, departoffsetdir=None, departoffsetintool=None, shadowrobotname=None, shadowrobottoolname=None, **kwargs):
    ...
    def RestoreSceneInitialState(self, timeout=1, preserverobotdofvalues=1, **kwargs):
    ...
    def RunMotorControlTuningMaximulLengthSequence(self, jointName, amplitude, timeout=10, unit='mm', robotname=None, toolname=None, robotBridgeConnectionInfo=None, locationCollisionInfos=None, robotspeed=None, robotaccelmult=None, ionames=None, **kwargs):
    ...
    def RunMotorControlTuningDecayingChirp(self, jointName, amplitude, freqMax, timeout=120, unit='mm', robotname=None, toolname=None, robotBridgeConnectionInfo=None, locationCollisionInfos=None, robotspeed=None, robotaccelmult=None, ionames=None, **kwargs):
    ...
    def RunMotorControlTuningGaussianImpulse(self, jointName, amplitude, timeout=20, unit='mm', robotname=None, toolname=None, robotBridgeConnectionInfo=None, locationCollisionInfos=None, robotspeed=None, robotaccelmult=None, ionames=None, **kwargs):
    ...
    def RunMotorControlTuningBangBangResponse(self, jointName, amplitude, timeout=60, unit='mm', robotname=None, toolname=None, robotBridgeConnectionInfo=None, locationCollisionInfos=None, robotspeed=None, robotaccelmult=None, ionames=None, **kwargs):
    ...
    def RunDynamicsIdentificationTest(self, timeout, unit='mm', robotname=None, toolname=None, robotBridgeConnectionInfo=None, locationCollisionInfos=None, robotspeed=None, robotaccelmult=None, ionames=None, **kwargs):
        """
    ...
    def GetTimeToRunDynamicsIdentificationTest(self, timeout=10, jointName=None, minJointAngle=None, maxJointAngle=None, unit='mm', robotname=None, toolname=None, robotBridgeConnectionInfo=None, locationCollisionInfos=None, robotspeed=None, robotaccelmult=None, ionames=None, **kwargs):
        """
    ...
    def CalculateTestRangeFromCollision(self, timeout=10, jointName=None, unit='mm', envclearance=None, robotname=None, toolname=None, robotBridgeConnectionInfo=None, locationCollisionInfos=None, robotspeed=None, robotaccelmult=None, ionames=None, **kwargs):
        """
    ...
    def GetMotorControlParameter(self, jointName, parameterName, timeout=10, unit='mm', robotname=None, toolname=None, robotBridgeConnectionInfo=None, locationCollisionInfos=None, robotspeed=None, robotaccelmult=None, ionames=None, **kwargs):
    ...
    def SetMotorControlParameter(self, jointName, parameterName, parameterValue, timeout=10, unit='mm', robotname=None, toolname=None, robotBridgeConnectionInfo=None, locationCollisionInfos=None, robotspeed=None, robotaccelmult=None, ionames=None, **kwargs):
    ...
    def ReplaceBodies(self, bodieslist, timeout=10, replaceInfos=None, testLocationName=None, testLocationContainerId=None, removeNamePrefixes=None, removeLocationNames=None, doRemoveOnlyDynamic=None, unit='mm', **kwargs):
